...
/**
 * Этап рефакторинга папки с репозиториями, нарушающими DRY, принципы наследования и ещё много какие принципы
 *
 * На входе в задаче была пачка ~50 разрозненных репозиториев, имеющих чаще всего одинаковые методы получения одной записи или 
 ...
 *
 * Сначала менялись ключевые, самые часто используемые в проекте репозитории. Подключался трейт, добавлятся PHPDock 
 ...
 *
 * К сожалению, весь задуманный рефакторинг довести до ума не удалось.
 * 
