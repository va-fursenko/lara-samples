 ...
 * Реквест используется только для общей валидации без логики, например, проверки возраста туристов или сопоставления 
 ...
 * особенности или пожелания партнёров. На практике, API берётся за эталон и обычно под него подстраиваются партнёры, 
